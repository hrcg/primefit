...
$logo_white = primefit_get_asset_uri( [ '/assets/media/logo-white.webp', '/assets/media/logo-white.png' ] );
$logo_black = primefit_get_asset_uri( [ '/assets/media/logo-black.webp', '/assets/media/logo-black.png' ] );
?>
